...
const ManageDecorators = () => {
  ...
  const decoratorCount = users.filter((u) => u.role === "decorator").length;
    ...
    <section className="p-4 md:p-8">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="stats shadow bg-green-100 text-green-800">
          <div className="stat">
            <div className="stat-title text-green-600">Decorators</div>
            <div className="stat-value">{decoratorCount}</div>
          </div>
        </div>
        <div className="stats shadow bg-red-100 text-red-800">
          <div className="stat">
            <div className="stat-title text-red-600">Admins</div>
                ...
                <td>
                  {user.role !== "admin" && (
                    <button
                      ...
                      className="btn btn-error btn-xs text-white mr-2"
                    >

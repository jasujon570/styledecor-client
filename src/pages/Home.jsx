      ...
      <section className="container mx-auto px-4 md:px-8 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Explore our top-rated decoration services designed to make your
        ...
        <div className="text-center mt-12">
          <Link
            to="/services"
            className="btn btn-primary btn-outline rounded-full px-10"
          >
            Show All Services
          </Link>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <div className="collapse collapse-plus bg-base-200">
            ...
            <div className="collapse-content">
              <p>
                Simply browse our services, click on View Details, and if you
                are logged in, you can click "Book Now" to select your preferred
                date.
              </p>
            </div>
          </div>
          <div className="collapse collapse-plus bg-base-200">
            ...
            <div className="collapse-content">
              <p>
                Yes, you can manage and cancel your bookings from the "My
                Bookings" section in your profile.
              </p>
            </div>
          </div>
        </div>
